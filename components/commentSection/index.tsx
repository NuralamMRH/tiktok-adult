...
export default function CommentSection({
  ...
  return (
    <div className='relative mx-auto flex h-full w-full max-w-3xl flex-col border-t pt-2 dark:border-t-darkBorder lg:h-screen lg:w-[500px] lg:border-l lg:pt-0 lg:dark:border-l-darkBorder'>
      ...
      {/* comments */}
      <div className='max-h-[400px] flex-1 overflow-hidden overflow-y-auto p-4 pb-24 lg:max-h-[unset] lg:p-6 lg:pb-6'>
      ...
      {/* add comment */}
      <div className='absolute bottom-0 left-0 w-full border-t p-4 py-4 dark:border-t-darkBorder lg:static lg:px-6'>
